...
1. Add 3 tee nuts on each side of the 311mm v-slots (12x tee nuts in total) as seen on figure 1.4 <br>
   :warning: this step is very important, double check you have use 12 Tee nuts (3 on each side of each 311 V-Slots as seen       on figure 1.4). If you forget this step, you will have to restart build from scratch ! If it's not clear, have a look on this [picture](https://github.com/gregsaun/prusa_i3_bear_upgrade/blob/master/full_upgrade/for_mk2_mk2s/manual/assembly_instructions/img/fig6.4.jpg) 
